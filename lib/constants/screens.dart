...
double suSetSp(double size, {double scale = 1.0}) =>
    _sizeCapable(ScreenUtil().setSp(size) * 2, scale: (scale ?? 1.0));

double suSetWidth(double size, {double scale = 1.0}) =>
    _sizeCapable(ScreenUtil().setWidth(size) * 2, scale: (scale ?? 1.0));

double suSetHeight(double size, {double scale = 1.0}) =>
    _sizeCapable(ScreenUtil().setHeight(size) * 2, scale: (scale ?? 1.0));

double _sizeCapable(double size, {double scale = 1.0}) => size * (scale ?? 1.0);
